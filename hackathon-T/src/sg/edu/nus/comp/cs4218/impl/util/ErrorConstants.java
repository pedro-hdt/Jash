...
public class ErrorConstants {
    ...
    public static final String ERR_INVALID_ARG = "Invalid arguments";
    ...
    public static final String ERR_DIR_NOT_EMPTY = "Directory is not empty";
    ...
    // `diff` related
    public static final String ERR_FILE_AND_DIR = "Cannot use diff to compare file and directory";
    public static final String ERR_TWO_STDIN = "Cannot have two stdin in diff";
    public static final String ERR_TWO_EMPTY_DIR = "Both directories are empty";
    ...
    // Cut related
    public static final String ERR_OUT_RANGE = "cut range out of range";
