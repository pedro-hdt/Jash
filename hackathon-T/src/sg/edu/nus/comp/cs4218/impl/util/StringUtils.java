...
public final class StringUtils {
    ...
    public static String[] tokenize(String str) {
        ...
        // Disable tokenizing if argument is part of quote
        if ((str.charAt(0) == CHAR_SINGLE_QUOTE || str.charAt(0) == CHAR_DOUBLE_QUOTE) && str.charAt(str.length() - 1) == str.charAt(0)) {
    ...
    /**
     * Checks if a string can be represented as a integer.
     *
     * @param str String possibly representing a integer
     * @return true if str can be represented as a integer
     */
    ...
    /**
     * Checks if a string can be represented as a zero.
     *
     * @param str String possibly representing a zero.
     * @return true if str can be represented as a zero.
     */
    public static boolean isNumericAndZero(String str) {
        if (str == null) {
            return false;
        }
        ...
        BigDecimal numeric;
        try {
            numeric = new BigDecimal(str);
        } catch (Exception e) {
            return false;
        }

        return numeric.compareTo(BigDecimal.ZERO) == 0;
    }
}
