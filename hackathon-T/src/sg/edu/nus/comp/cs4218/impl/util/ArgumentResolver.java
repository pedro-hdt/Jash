...
public class ArgumentResolver {
    ...
    private String evaluateSubCommand(String commandString) throws AbstractApplicationException, ShellException {
        ...
        // Probably to make the output of command become new arguments, but now for echo, outputstream prints with a \n at the end, so gotta trim it
        // replace newlines with spaces
        return outputStream.toString().replace(STRING_NEWLINE, String.valueOf(CHAR_SPACE)).trim();
    }
