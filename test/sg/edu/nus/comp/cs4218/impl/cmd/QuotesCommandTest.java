...
import sg.edu.nus.comp.cs4218.impl.TestUtils;
...
public class QuotesCommandTest {
    ...
    static void setupAll() {
        Environment.setCurrentDirectory(ORIGINAL_DIR + File.separator + "dummyTestFolder" + File.separator + "QuotesCommandTest");
    }
