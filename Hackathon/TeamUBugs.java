...
class TeamUBugs {
    ...
    public void testRmNonEmptyFolderRecursive() throws IOException, AbstractApplicationException {
    ...
    public void testRmEmptyFolderRecursive() throws IOException, AbstractApplicationException {
    ...
    @Test
    @DisplayName("Bug #8")
    public void testCpFolderToItselfWithAnotherValidFile() throws IOException, AbstractApplicationException {
    ...
    @Test
    @DisplayName("Bug #11")
    public void testPasteTwoStdinArgs() throws IOException, AbstractApplicationException {
    ...
    @Test
    @DisplayName("Bug #12")
    public void testPasteOneFileOneStdinArgs() throws AbstractApplicationException, IOException {
    ...
    public void testOutOfRange() {
        ...
        assertEquals(expectedException.getMessage(), "error out of range");
    }
