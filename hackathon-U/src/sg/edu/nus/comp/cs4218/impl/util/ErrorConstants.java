...
public class ErrorConstants {
    ...
    public static final String ERR_IS_NON_EMPTY_DIR = "This is a non-empty directory";
    public static final String ERR_CURR_DIR = "This is current directory";
    public static final String ERR_SAME_FILE = "'%s' and '%s' are the same file";
    public static final String ERR_SAME_DIR = "'%s' and '%s' are the same dir";
    ...
    public static final String ERR_MISSING_OPERAND = "missing operand";
    ...
    // `sort` related
    public static final String ERR_FIRST_IS_NOT_NUMBER = "First word of line is not number";
    ...
    // `mv` related
    public static final String ERR_SRC_DIR_DES_FILE = "Source file '%s' is directory while destination file '%s' is file";
    public static final String ERR_EXISTING_DES_CANNOT_REPLACE = "Destination file '%s' already exists and cannot be replaced";
    public static final String ERR_EXISTING_DES_IN_DIR_CANNOT_REPLACE = "A file with the same name '%s' already exists in '%s' directory and cannot be replaced";
    ...
    // IORedirectionHandler
    public static final String ERR_MULTIPLE_REDIR_OPERATOR = "Multiple redirection-operators";
