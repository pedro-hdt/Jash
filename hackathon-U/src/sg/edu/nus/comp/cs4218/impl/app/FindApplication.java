...
import sg.edu.nus.comp.cs4218.impl.app.args.FindArguments;
...
public class FindApplication implements FindInterface {
    ...
    private static final String COMMAND_HEADER = "find: ";
    ...
    public void run(String[] args, InputStream stdin, OutputStream stdout) throws AbstractApplicationException {
        ...
        try {
            ...
            FindArguments findArgumentsArgs = new FindArguments();
            findArgumentsArgs.parse(args);
            String fileName = findArgumentsArgs.getFilename();
            String[] folderNamesArray = new String[findArgumentsArgs.getDirectories().size()];
            folderNamesArray = findArgumentsArgs.getDirectories().toArray(folderNamesArray);
