...
public class MvApplicationTest {
    ...
    static void reset() throws IOException {
        ...
        Files.createFile(Paths.get(Environment.currentDirectory
          + StringUtils.fileSeparator() + DEST_DIR + StringUtils.fileSeparator() + OVERWRITE_FILE));
        FileOutputStream outputStream = new FileOutputStream(new File(Paths.get(Environment.currentDirectory //NOPMD
    ...
    public void testFailsWithLessThan2Args() {
        Exception expectedException = assertThrows(MvException.class, () -> mvApp.run(new String[0], System.in, stdout));
        assertTrue(expectedException.getMessage().contains(ERR_NO_FILE_ARGS));
    
        expectedException = assertThrows(MvException.class, () -> mvApp.run(new String[1], System.in, stdout));
        assertTrue(expectedException.getMessage().contains(ERR_NO_FILE_ARGS));
    ...
    public void testIllegalArgsException() {
        ...
        Exception expectedException = assertThrows(MvException.class, () -> mvApp.run(new String[]{"no-file.txt", "no-dir", "-f"}, System.in, stdout));
    ...
    public void testRenamingFailsWhenFileNotPresent() {
        Exception expectedException = assertThrows(MvException.class, ()
          -> mvApp.run(new String[]{"file-not-present.txt", NEW_NAME_FILE}, System.in, stdout));
    ...
    public void testMovingFailsWhenFileNotPresent() {
        Exception expectedException = assertThrows(MvException.class, ()
          -> mvApp.run(new String[]{"file-not-present.txt", DEST_DIR}, System.in, stdout));
        assertTrue(expectedException.getMessage().contains(ERR_FILE_NOT_FOUND));
    ...
    public void testRenameExistingFile() {
        try {
            mvApp.run(new String[]{OLD_NAME_FILE, NEW_NAME_FILE}, System.in, stdout);
    ...
    public void testAttemptOverwritingMultipleFiles() {
        ...
        Exception expectedException = assertThrows(MvException.class, ()
          -> mvApp.run(new String[]{OLD_NAME_FILE, MOVE_FIRST_TXT, OLD_NAME_FILE}, System.in, stdout));
    ...
    void testMoveSameFolderWithAnotherValidFile() throws IOException {
        ...
        try {
            ...
            Files.deleteIfExists(Paths.get(Environment.currentDirectory, DIR_A, FILE_B_TXT));
            Files.deleteIfExists(Paths.get(Environment.currentDirectory
    ...
    public void testRenameMultipleFilesException() {
        Exception expectedException = assertThrows(MvException.class, () -> mvApp.run(new String[]{OLD_NAME_FILE, MOVE_FIRST_TXT, "random-new-name.txt"}, System.in, stdout));
    ...
    public void testRenameExistingDirectory() throws Exception {
        ...
        mvApp.run(new String[]{OLD_DIR, NEW_DIR}, System.in, stdout);
    ...
    public void testMoveFileToDir() {
        try {
            mvApp.run(new String[]{FILE_TO_MOVE_TXT, DEST_DIR}, System.in, stdout);
    
            assertTrue(Files.exists(Paths.get(Environment.currentDirectory
              + StringUtils.fileSeparator() + DEST_DIR + StringUtils.fileSeparator() + FILE_TO_MOVE_TXT)));
    ...
    public void testMoveDirToAnotherDir() throws Exception {
        ...
        mvApp.run(new String[]{INIT_DIR, DEST_DIR}, System.in, stdout);
    ...
    public void testDontOverwriteFile() throws Exception {
        ...
        assertFalse(Arrays.equals(Files.readAllBytes(IOUtils.resolveFilePath(NO_OVERWRITE_FILE)),
          Files.readAllBytes(Paths.get(Environment.currentDirectory
        ...
        Exception expectedException = assertThrows(MvException.class, ()
          ...
          + NO_OVERWRITE_FILE, NO_OVERWRITE_FILE}, System.in, stdout));
    ...
    public void testCantMoveToNonEmptyDir() {
        ...
        Exception expectedException = assertThrows(MvException.class, ()
          -> mvApp.run(new String[]{"toBeMoved", "abc"}, System.in, stdout));
    ...
    public void testOverwriteFileSuccess() throws IOException {
        try {
            mvApp.run(new String[]{DEST_DIR + StringUtils.fileSeparator() + OVERWRITE_FILE, OVERWRITE_FILE}, System.in, stdout);
    ...
    public void testMoveMultipleFiles() throws MvException {
        mvApp.run(new String[]{MOVE_FIRST_TXT, MOVE_SECOND_TXT, DEST_DIR, "-n"}, System.in, stdout);
    ...
    void testFileAlreadyExistsWithNoOverwriteAllowed() throws IOException {
        ...
        Exception expectedException = assertThrows(MvException.class, ()
          -> mvApp.run(new String[]{fileA, dirB, "-n"}, System.in, stdout));
        assertEquals("mv: " + ERR_CANNOT_OVERWRITE + " file already exists: fileA.txt", expectedException.getMessage());
    
        Files.deleteIfExists(Paths.get(Environment.currentDirectory, dirB, fileA));
        Files.deleteIfExists(Paths.get(Environment.currentDirectory, dirB));
        Files.deleteIfExists(Paths.get(Environment.currentDirectory, fileA));
    }
