...
import tddmod.util.FilePermissionTestUtil;
import tddmod.util.RmTestUtil;
...
public class RmApplicationTest {
    ...
    @Test
    @Disabled("exception not thrown but error printed to stdout correctly")
    ...
    @Test
    @Disabled("exception not thrown but correct handling of situation")
